...
- [ ] `r advdate(dayone, 6, topic)`
  ...
  - Finish portfolio piece 3 by `r startweek`:  `r advdate(dayone, 6, assignment=startweek)`
...
- [ ] `r advdate(dayone, 9, topic)`
  ...
  - Finish portfolio piece 5 by `r startweek`:  `r advdate(dayone, 9, assignment=startweek)`
- [ ] `r advdate(dayone, 10, topic)`
  - Finish portfolio piece 6 by `r startweek`:  `r advdate(dayone, 10, assignment=startweek)`
...
- [ ] `r advdate(dayone, 13, topic)`
  ...
  - Finish portfolio piece 9 by `r startweek`:  `r advdate(dayone, 13, assignment=startweek)`
- [ ] `r advdate(dayone, 14, topic)`
  - Finish Lab 10 by `r startweek`:  `r advdate(dayone, 14, assignment=startweek)`  
- [ ] `r advdate(dayone, 15, topic)`
  - Finish portfolio piece 10 by `r startweek`:  `r advdate(dayone, 15, assignment=startweek)`
  - Finish Lab 11 by `r startweek`:  `r advdate(dayone, 15, assignment=startweek)`
